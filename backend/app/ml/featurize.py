...
_PHRASE_TO_TOKEN: dict[str, str] = {
    ...
    "tightness in my jaw": "radiation_jaw",
    "tightness in the jaw": "radiation_jaw",
    "tightness in jaw": "radiation_jaw",
    "jaw tightness": "radiation_jaw",
    "jaw feels tight": "radiation_jaw",
    "pain in my jaw": "radiation_jaw",
    "pain in the jaw": "radiation_jaw",
    ...
    "face is swollen": "swelling",
    "his face is swollen": "swelling",
    "her face is swollen": "swelling",
    "face swollen": "swelling",
    "lips are swollen": "swelling",
    "lips swollen": "swelling",
    "throat closing": "throat_tightness",
    "throat tight": "throat_tightness",
    "throat feels tight": "throat_tightness",
    "throat is tight": "throat_tightness",
    "tightness in throat": "throat_tightness",
    "tightness in my throat": "throat_tightness",
    "tight throat": "throat_tightness",
    "wheezing": "wheezing",
    "wheeze": "wheezing",
    ...
    "black and tarry": "black_tarry_stool",
    "stools have been black": "black_tarry_stool",
    "stools are black": "black_tarry_stool",
    "stool is black": "black_tarry_stool",
    "stool has been black": "black_tarry_stool",
    "passing black stool": "black_tarry_stool",
    "passed black stool": "black_tarry_stool",
    ...
    "i look pale": "pale",
    "i am pale": "pale",
    "dizzy when i stand": "dizziness",
    "dizzy when standing": "dizziness",
    ...
    "breath smells funny": "fruity_breath",
    "breath smells sweet": "fruity_breath",
    "breath smells fruity": "fruity_breath",
    "breath smells like fruit": "fruity_breath",
    "sweet smelling breath": "fruity_breath",
    "fruity smelling breath": "fruity_breath",
    "rapid breathing": "rapid_breathing",
    "very thirsty": "high_thirst",
    "so thirsty": "high_thirst",
    "really thirsty": "high_thirst",
    "extremely thirsty": "high_thirst",
    "incredibly thirsty": "high_thirst",
    "constantly thirsty": "high_thirst",
    "i am thirsty": "high_thirst",
    "i'm thirsty": "high_thirst",
    "im thirsty": "high_thirst",
